    ...
    return (
      <div className="margintop" id="container">
          <div id="left">
            ...
            <span className="verIndent"></span>
            <span className="responsiveFSize2">- You can add a new product. A notification should appear on top of each company section ( not like other notifications ).</span>
            <span className="verIndent"></span>
