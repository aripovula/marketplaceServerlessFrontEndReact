                        ...
                        <div className="card-4" >
                            ...
                            <div className="padding15 responsiveFSize">
                                ...
                                {!this.props.isUpdateAtStart &&
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => {
                                                this.props.handleSelectOptionChange(e.target.value);
                                            }}
                                        >
                                    ...
                                    <div>
                                        {!this.props.isUpdateAtStart &&
                                            <div className="">
                                                ...
                                                <input id="oneoff" type="radio" value="1" name="orderType"
                                                    checked={this.props.oneOffOrRule === 1} onChange={this.props.updateOrderType.bind(this)} />
                                                &nbsp;&nbsp;
                                            <label htmlFor="ruleonly">&nbsp;re-order rule &nbsp;</label>
                                                <input id="ruleonly" type="radio" value="2" name="orderType"
                                                    checked={this.props.oneOffOrRule === 2} onChange={this.props.updateOrderType.bind(this)} />
                                            </div>
                                        }
                                        <br />
                                        ...
                                        {(this.props.order.bestOfferType === 'OPTIMAL' || this.props.order.bestOfferType === 'CUSTOM') &&
                                            <div className="floatRight">
                                                ...
                                                <select
                                                    ...
                                                    onChange={(e) => this.props.handleSelectSecondBestOptionChange(e.target.value)}
                                                >
                                        ...
                                        <div className="">
                                            &nbsp;&nbsp;<input id="optimal" type="radio" value="OPTIMAL" name="bestorder"
                                                ...
                                                onChange={(e) => this.props.handleBestOfferTypeChange(e)} />
                                        ...
                                        {(this.props.order.bestOfferType === 'CUSTOM' || this.props.order.bestOfferType === 'HIGHESTRATING') &&
                                            <div className="">
                                                ...
                                                <input type="text" id="price" value={this.props.order.maxPrice} onChange={this.props.handleChange.bind(this, 'maxPrice')} />
                                                <button className="buttonSm button2a" onClick={() => this.props.handlePriceChange(0.99)}>- 1%</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handlePriceChange(1.01)}>+ 1%</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handlePriceChange(0.96)}>- 4%</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handlePriceChange(1.04)}>+ 4%</button>&nbsp;
                                            </div>
                                        }
                                        {(this.props.order.bestOfferType === 'CUSTOM' || this.props.order.bestOfferType === 'OPTIMAL') &&
                                            <div className="">
                                                ...
                                                <input type="text" id="minProductRating" value={this.props.order.minProductRating} onChange={this.props.handleChange.bind(this, 'minProductRating')} />
                                                <button className="buttonSm button2a" onClick={() => this.props.handleRatingChange(-0.1, 1)}>- 0.1</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleRatingChange(0.1, 1)}>+ 0.1</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleRatingChange(4, 0)}>4.0</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleRatingChange(4.2, 0)}>4.2</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleRatingChange(4.4, 0)}>4.4</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleRatingChange(4.6, 0)}>4.6</button>&nbsp;
                                            </div>
                                        }
                                        <br />
                                        ...
                                        {!(this.props.oneOffOrRule === 2) &&
                                            <div className="">
                                                ...
                                                <input type="text" id="quantity" value={this.props.order.quantity} onChange={this.props.handleChange.bind(this, 'quantity')} />
                                                <button className="buttonSm button2a" onClick={() => this.props.handleQuantityChange(-10)}>- 10</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleQuantityChange(10)}>+ 10</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleQuantityChange(-100)}>- 100</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleQuantityChange(100)}>+ 100</button>&nbsp;
                                            </div>
                                        }
                                        ...
                                        {!(this.props.oneOffOrRule === 1) &&
                                            <div>
                                                <div>reorder &nbsp;
                                                <input type="text" id="reorderQnty" value={this.props.order.reorderQnty} onChange={this.props.handleChange.bind(this, 'reorderQnty')} />
                                                    &nbsp; items&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleReorderQntyChange(-10)}>- 10</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleReorderQntyChange(10)}>+ 10</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleReorderQntyChange(-100)}>- 100</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleReorderQntyChange(100)}>+ 100</button>&nbsp;
                                            </div>
                                                <div>when stock is below&nbsp;
                                                <input type="text" id="reorderLevel" value={this.props.order.reorderLevel} onChange={this.props.handleChange.bind(this, 'reorderLevel')} />
                                                    <button className="buttonSm button2a" onClick={() => this.props.handleReorderLevelChange(-10)}>- 10</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleReorderLevelChange(10)}>+ 10</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleReorderLevelChange(-100)}>- 100</button>&nbsp;
                                                <button className="buttonSm button2a" onClick={() => this.props.handleReorderLevelChange(100)}>+ 100</button>&nbsp;
                                            </div>
                                            </div>
                                        }
                                        ...
                                        <div className="" >
                                            ...
                                            <input id="credit" type="radio" value="false" name="paymenttype"
                                                checked={!this.props.order.isCashPayment} onChange={this.props.updateSettlementType.bind(this)} />
                                            &nbsp;&nbsp;
                                ...
                                <div className="">
                                    ...
                                    {(this.props.isUpdateAtStart || this.props.isUpdate) &&
                                        <button className="button button1" onClick={this.props.handleSaveUpdate} disabled={!this.props.isSubmitValid &&
                                            !this.props.isUpdateAtStart}>
                                            Update rule
                                            </button>
                                    }
                                    ...
                                    {(this.props.isUpdateAtStart || this.props.isUpdate) &&
                                        <span>
                                            <button className="button button1" onClick={this.props.handleSuspendResume.bind(this, this.props.order)}>
                                                {this.props.order.isRuleEffective ? 'Suspend rule' : 'Resume rule'}  </button>
                                            <button className="button button1 floatRight" onClick={this.props.handleDelete.bind(this, this.props.order)}>
                                                Delete rule</button>
                                        </span>
                                    }
